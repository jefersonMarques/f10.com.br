...
<ApplicationContent width="standard">
  <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <ApplicationBackLink href="/app/help/flows" label="Fluxos" />
  ...
  <section class="mb-4 rounded-[22px] border border-[#E2E5ED] bg-white px-5 py-4 sm:px-6">
    <div class="flex flex-col justify-between gap-4 lg:flex-row lg:items-center">
      <div class="min-w-0">
        <h2 class="truncate text-[18px] font-semibold text-[#11182C]">{data.question.title}</h2>
        <p class="mt-1 max-w-[760px] text-[11px] leading-5 text-[#747A8A]">
