          ...
          <section class="mt-7 border-t border-[#EEF0F5] pt-6">
            ...
            {#if data.canEdit}
              <div class="mt-5 grid gap-3 lg:grid-cols-3">
                ...
                <details class="rounded-2xl border border-[#DDE1EA] bg-white p-4"><summary class="flex cursor-pointer list-none items-center gap-2 text-[10px] font-semibold text-[#000A57]"><ImageIcon size={15} aria-hidden="true" />Adicionar imagem por URL</summary><form method="POST" action="?/addBlock" class="mt-4 space-y-3"><input type="hidden" name="stepId" value={step.id} /><input type="hidden" name="blockType" value="image" /><input name="sourceUrl" required placeholder="https://..." class="h-10 w-full rounded-xl border border-[#DDE1EA] px-3 text-[10px]" /><input name="altText" maxlength="500" placeholder="O que aparece na imagem" class="h-10 w-full rounded-xl border border-[#DDE1EA] px-3 text-[10px]" /><textarea name="aiSummary" maxlength="20000" rows="3" placeholder="O que a IA precisa saber sobre esta imagem" class="w-full rounded-xl border border-[#D8DDF4] bg-[#F8F9FF] px-3 py-2 text-[10px]"></textarea><button type="submit" class="min-h-9 w-full rounded-xl bg-[#000A57] px-3 text-[10px] font-semibold text-white">Adicionar imagem</button></form></details>
                <details class="rounded-2xl border border-[#DDE1EA] bg-white p-4"><summary class="flex cursor-pointer list-none items-center gap-2 text-[10px] font-semibold text-[#000A57]"><Video size={15} aria-hidden="true" />Adicionar vídeo</summary><form method="POST" action="?/addBlock" class="mt-4 space-y-3"><input type="hidden" name="stepId" value={step.id} /><input type="hidden" name="blockType" value="video" /><input name="sourceUrl" required placeholder="URL do vídeo" class="h-10 w-full rounded-xl border border-[#DDE1EA] px-3 text-[10px]" /><input name="altText" maxlength="500" placeholder="Descrição do vídeo" class="h-10 w-full rounded-xl border border-[#DDE1EA] px-3 text-[10px]" /><textarea name="transcript" maxlength="100000" rows="4" placeholder="Transcrição ou conteúdo do vídeo para a IA" class="w-full rounded-xl border border-[#D8DDF4] bg-[#F8F9FF] px-3 py-2 text-[10px]"></textarea><textarea name="aiSummary" maxlength="20000" rows="3" placeholder="Resumo adicional para IA" class="w-full rounded-xl border border-[#D8DDF4] bg-[#F8F9FF] px-3 py-2 text-[10px]"></textarea><button type="submit" class="min-h-9 w-full rounded-xl bg-[#000A57] px-3 text-[10px] font-semibold text-white">Adicionar vídeo</button></form></details>
              </div>
            {/if}
          </section>
        </div>
