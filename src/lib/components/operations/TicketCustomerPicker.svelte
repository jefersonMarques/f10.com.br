...
<div class="sm:col-span-2 grid gap-3 sm:grid-cols-2">
  ...
  <label class="block sm:col-span-2"><span class="application-text-meta mb-1.5 block font-bold uppercase tracking-[0.07em] text-[#858B99]">Conclusão planejada</span><input name="dueOn" type="date" required class="application-text-caption h-10 w-full rounded-xl border border-[#DDE1EA] bg-white px-3 outline-none focus:border-[#000A57]"/></label>
</div>
