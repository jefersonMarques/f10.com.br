...
>
  <div class="flex items-start gap-3">
    ...
    <div class="min-w-0 flex-1">
      ...
      <span class="application-text-caption mt-1 block leading-5 text-[#858B99]">Selecione, arraste ou use <strong>Ctrl+V</strong>. Prefira a captura da tela inteira. As marcações são feitas depois pela opção <strong>Marcar imagens</strong> do artigo.</span>
    </div>
  </div>
