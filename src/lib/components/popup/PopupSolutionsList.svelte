...
{#if mounted && portal && isOpen}
  ...
  >
    ...
    <div
      class={`relative z-10 bg-white rounded-2xl w-[92%] max-h-[90vh] lg:max-h-[100vh] ${sizeClass} overflow-hidden shadow-2xl animate-fadeIn transition-all duration-300`}
    >
      <button
        on:click={closeModal}
